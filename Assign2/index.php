...
<title>Untitled Document</title>
	<style type="text/css">
		...
		fieldset inputiSubmitBtn {background: #e5e5e5; color: #000099; border: 1px solid #ccc; padding: 5px; width: 150px;}nfo { position: absolute; top: 60px; left: 20px; width: 460px;}
	</style>
</head>
